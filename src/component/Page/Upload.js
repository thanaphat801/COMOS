...
const Upload_4 = () => {
  ...
  const errorMessages = {
    noCameraAccessible: 'ไม่พบกล้อง กรุณากดปุ่ม cancel เพื่อย้อนกลับไปหน้าแรก',
    permissionDenied: 'ไม่ได้รับอนุญาตให้เข้าถึงกล้อง กรุณาอนุญาตให้เข้าถึงกล้อง กดปุ่ม cancel เพื่อย้อนกลับไปหน้าแรก',
    switchCamera: 'ไม่สามารถสลับกล้องได้ กรุณาลองใหม่อีกครั้ง กดปุ่ม cancel เพื่อย้อนกลับไปหน้าแรก',
    canvasError: 'เกิดข้อผิดพลาดในการแสดงภาพ กรุณาลองใหม่อีกครั้ง กดปุ่ม cancel เพื่อย้อนกลับไปหน้าแรก',
  };
  ...
  const handleSubmit = (e) => {
    ...
    axios
      .post("http://localhost:5000/search_image", formData, {
        headers: {
        ...
        {openphoto && (
          <Dialog open={true} size={"xxl"}>
            ...
            <div className="absolute flex items-center justify-center w-screen h-screen">
              <div className="flex flex-col justify-evenly rounded-xl shadow-lg bg-white w-[550px] h-[650px] ">
                ...
                <div className="flex justify-around w-full">
                  <Button
                    ...
                    className="mr-1 font-prompt text-base"
                  >
                    <span>ยกเลิก</span>
                  </Button>
              ...
              <div className="flex flex-col items-center justify-center rounded-xl shadow-lg bg-white w-[550px] h-[650px] ">
                <img
                  ...
                  className='w-96 sm:w-[500px] '
                   ...
                   // สลับด้านซ้าย-ขวาของภาพ Preview
                />
                ...
                {images.map((image, index) => (
                  ...
                  >
                    ...
                    <Button
                      ...
                      color="red"
                      onClick={handleCancel}
                      className="mb-2 font-prompt text-base"
                    >
                      ออก
                    </Button>
